...
async function seed() {
  ...
  const tasks = await Task.insertMany([
    ...
    { sprintId: sprint._id, teamId: team._id, title: 'Containerise services with Docker', description: 'Create Dockerfiles for all services and set up docker-compose. Configure for containerised deployment.', storyPoints: 5, priority: 'MEDIUM', status: 'IN_REVIEW', assigneeId: users[4]._id, reporterId: users[0]._id },
